...
// /// Mock of ../count_style.dart
// class CountStyle {
//   final TextStyle? textStyle;
//   CountStyle({this.textStyle});
// }

// /// Mock of ../tab_item.dart
// class TabItem {
//   final String? title;
//   final IconData? icon;
//   final String? key;
...
//   TabItem({this.title, this.icon, this.key, this.count});
// }

// /// Mock of ../widgets/build_icon.dart
...
//       children: [
//         Icon(item.icon ?? Icons.circle, color: iconColor, size: iconSize),
//         if ((item.count ?? 0) > 0)
//           Positioned(
//             right: 0,
//             top: 0,
...
// /// Mock of 'bottom_bar.dart'
// class BuildLayout extends StatelessWidget {
//   final Widget? child;
//   final BoxDecoration? decoration;
//   final double? blur;

//   const BuildLayout({Key? key, this.child, this.decoration, this.blur})
//     : super(key: key);
